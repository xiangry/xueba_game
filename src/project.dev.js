window.__require = function e(t, n, r) {
  ...
  DontDestroy: [ function(require, module, exports) {
    "use strict";
    cc._RF.push(module, "d6d118QuEpNQrJXKVjLjvwu", "DontDestroy");
    "use strict";
    require("../logic/game");
    cc.Class({
  ...
  GameScene: [ function(require, module, exports) {
    "use strict";
    cc._RF.push(module, "98b01kTKxNCtK7QY8KW17sD", "GameScene");
    "use strict";
    cc.Class({
      extends: cc.Component,
      properties: {},
      ...
      openLoginPop: function openLoginPop() {
        UIManager.PushUi(EUI.LoginPop);
      },
      registMsgFunc: function registMsgFunc() {
        var self = this;
  ...
  ListView: [ function(require, module, exports) {
    "use strict";
    cc._RF.push(module, "0c19226EpJKioByJou5Rd6K", "ListView");
    "use strict";
    cc.Class({
      extends: cc.Component,
      properties: {
      ...
      btnItemClickHandler: function btnItemClickHandler(btn) {
  ...
  cc_util: [ function(require, module, exports) {
    "use strict";
    cc._RF.push(module, "88960OSRaNGBrf3CSFxcx8z", "cc_util");
    "use strict";
    window.CC_UTIL = {};
  ...
  data_center: [ function(require, module, exports) {
    "use strict";
    cc._RF.push(module, "2a7ffCAyqFAwYSMQ7T3ISkS", "data_center");
    "use strict";
  ...
  enum: [ function(require, module, exports) {
    "use strict";
    cc._RF.push(module, "e0d536rJedLaLYPZuJ3G2K8", "enum");
    "use strict";
  ...
  game: [ function(require, module, exports) {
    "use strict";
    cc._RF.push(module, "abf8cFHTHJFrayKwDewUtWd", "game");
    "use strict";
    require("./enum");
    require("./global");
    require("./cc_util");
    ...
    var notice_manager = require("./notice_manager");
    var data_center = require("./data_center");
  ...
  global: [ function(require, module, exports) {
    "use strict";
    cc._RF.push(module, "b677auOOgdJdpKG4+gO6leW", "global");
    "use strict";
    window.G = {};
    cc._RF.pop();
  }, {} ],
  info_item: [ function(require, module, exports) {
    "use strict";
    cc._RF.push(module, "ceac4FUKxhI/Kdytpi5dSSy", "info_item");
    "use strict";
    cc.Class({
      extends: cc.Component,
      properties: {
  ...
  input: [ function(require, module, exports) {
    "use strict";
    cc._RF.push(module, "9084evk2PdLpKM4WwPcgidm", "input");
    "use strict";
    cc.Class({
      extends: cc.Component,
      properties: {
  ...
  loading: [ function(require, module, exports) {
    "use strict";
    cc._RF.push(module, "2b07fO5UdpBPbNkx+xt6m8x", "loading");
    "use strict";
  ...
  login_pop: [ function(require, module, exports) {
    "use strict";
    cc._RF.push(module, "cb157KYKslDF4vXcOu6sV3y", "login_pop");
    "use strict";
    cc.Class({
      name: "LoginPop",
      extends: UIBaseView,
      ...
      onLoginClick: function onLoginClick(event, data) {
      ...
      doLoginServer: function doLoginServer(account, password) {
  ...
  main_page: [ function(require, module, exports) {
    "use strict";
    cc._RF.push(module, "114a4nKLfNDdoHjduTX6L51", "main_page");
    "use strict";
    ...
    cc.Class({
      ...
      refreshAge: function refreshAge() {
        this.lab_age.string = "" + DataCenter.age;
      },
      refreshExp: function refreshExp() {
    ...
    "../../logic/ui_base": "ui_base"
  } ],
  message: [ function(require, module, exports) {
    "use strict";
    cc._RF.push(module, "43c123QabxJIrA1opC4kD2Y", "message");
    "use strict";
    require("./proto");
  ...
  notice_manager: [ function(require, module, exports) {
    "use strict";
    cc._RF.push(module, "c95e9theLVHT5PJBSh/Zqh2", "notice_manager");
    "use strict";
    var XBNoticeManager = cc.Class({
      name: "XBNoticeManager",
      ctor: function ctor() {
        this.linsters = {};
      },
      Notice: function Notice(notice) {
        var list = this.linsters[notice];
        console.log("this.linsters ==== ", this.linsters);
        void 0 != list && list.length > 0 && list.forEach(function(linster, index) {
          linster.func.call(linster.notice, linster.obj);
        });
      },
      BeginListen: function BeginListen(notice, func, obj) {
        console.log("----BeginListen", notice);
        void 0 == this.linsters[notice] && (this.linsters[notice] = []);
        var list = this.linsters[notice];
        list.push({
          notice: notice,
          obj: obj,
      ...
      EndListen: function EndListen(notice, func, obj) {
        if (void 0 != this.linsters[notice]) for (var i = 0; i < this.linsters[notice].length; i++) {
  ...
  proto: [ function(require, module, exports) {
    "use strict";
    cc._RF.push(module, "b8e4fsAC1dMLZ74xoeE3wXs", "proto");
    "use strict";
    require("./message");
    window.EMsgProto = {
      Login: 1,
  ...
  scheduler: [ function(require, module, exports) {
    "use strict";
    cc._RF.push(module, "c3dee8wYV5OJbbe7y78E7/s", "scheduler");
    "use strict";
    var XBScheduler = function XBScheduler() {
      this.component = null;
    };
  ...
  "socket.io": [ function(require, module, exports) {
    (function(Buffer) {
      "use strict";
      cc._RF.push(module, "944faWknzRDD5TGKUtGw/8k", "socket.io");
      "use strict";
  ...
  socket: [ function(require, module, exports) {
    "use strict";
    cc._RF.push(module, "1244ctVL21Cj6lRnMrfqsHo", "socket");
    "use strict";
    require("./message");
    var XBSocket = function XBSocket() {
    ...
    "../Script/socket.io": "socket.io",
    "./message": "message"
  } ],
  template: [ function(require, module, exports) {
    "use strict";
    cc._RF.push(module, "3b9cc9Wu+dKLqMtHRn8a3mr", "template");
    "use strict";
    cc.Class({
      extends: cc.Component,
      properties: {},
  ...
  test: [ function(require, module, exports) {
    "use strict";
    cc._RF.push(module, "57e61cR/rZBF7/sMGQ3txO8", "test");
    "use strict";
    cc.Class({
      extends: cc.Component,
      properties: {
  ...
  ui_base: [ function(require, module, exports) {
    "use strict";
    cc._RF.push(module, "5ce5eeFtQxHXJo31YdjvQ1E", "ui_base");
    "use strict";
    var UIBaseView = cc.Class({
      name: "UIBaseView",
      properties: {
        rootNode: null,
        prefab: ""
  ...
  ui_manager: [ function(require, module, exports) {
    "use strict";
    cc._RF.push(module, "2c24a8CpkBG36CEhBOpvl8E", "ui_manager");
    "use strict";
    window.EUI = {
      LoginPop: "LoginPop",
      MainPage: "MainPage",
    ...
    var ui_config = {
      LoginPop: {
        path: "login/login_pop",
        class: require("../Script/login/login_pop")
      },
      MainPage: {
        path: "main_page/main_page",
        class: require("../Script/main_page/main_page")
      },
      Loading: {
        path: "pops/loading",
        class: require("../Script/pops/loading")
      }
    };
    var XBUiManager = function XBUiManager() {
      this.uiStacks = [];
      this.uiCur = void 0;
    };
    XBUiManager.prototype.PushUi = function(name, params) {
      ...
      void 0 != index && this._popUiByIndex(index);
      ...
      } else console.log("PushUi not find ui setting ");
    };
    XBUiManager.prototype.PopUi = function(name) {
      void 0 != name ? this._popUiByIndex(this.indexOfUi(name)) : this._popUiByIndex(this.uiStacks.length - 1);
    };
    XBUiManager.prototype._popUiByIndex = function(index) {
      if (void 0 != index) {
        var ui = this.uiStacks[index];
        if (ui) {
    ...
    XBUiManager.prototype.indexOfUi = function(name) {
      if (void 0 != name) for (var i = 0; i < this.uiStacks.length; i++) if (this.uiStacks[i].name === name) return i;
    };
    module.exports = XBUiManager;
    cc._RF.pop();
  }, {
    "../Script/login/login_pop": "login_pop",
    "../Script/main_page/main_page": "main_page",
    "../Script/pops/loading": "loading"
  } ]
}, {}, [ "DontDestroy", "GameScene", "ListView", "login_pop", "main_page", "loading", "info_item", "input", "socket.io", "template", "test", "cc_util", "data_center", "enum", "game", "global", "message", "notice_manager", "proto", "scheduler", "socket", "ui_base", "ui_manager" ]);